...
RES_X = render_utils.getArg(argv, 'resx', int, 800)
RES_Y = render_utils.getArg(argv, 'resy', int, 600)
NUM_SAMPLES = render_utils.getArg(argv, 'nsamples', int, 128)
...
FLENGTH = render_utils.getArg(argv, 'flength', float, 24.0)
RESOLUTION = (RES_X, RES_Y)

NUM_SEQ = render_utils.getArg(argv, 'nseq', int, 4)
...
if __name__ == '__main__':
    ...
    for blend_file in blend_files:
        try:
            ...
            render_utils.prepareCameraSet5(base_camera=camera)
